...
def main(args, extras) -> None:
    ...
    def _write_overall_timing_summary(trial_dir: str, fit_wall: float, test_wall: float) -> None:
        ...
        training_summary = os.path.join(trial_dir, "training_timing_summary.txt")
        ...
        with open(summary_path, "w") as f:
            ...
            if os.path.exists(training_summary):
                f.write("\n[training from training_timing_summary.txt]\n")
                with open(training_summary, "r") as tf:
                    f.write(tf.read())
                f.write("\n")
            if os.path.exists(timings_summary):
                f.write("\n[inference from timings_summary.txt]\n")
                with open(timings_summary, "r") as tf:
                    f.write(tf.read())
